...
A token is used for giving users permission to authorized certain parts of a web page or app once authentication is completed successfully.

2. What steps can you take in your web apps to keep your data secure?

3. Describe how web servers work.

Web servers serve as storage for written code of a site or app. When a URL is entered, a route is being called. The code for a particular route being called is being served from the web server.
